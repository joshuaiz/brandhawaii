...
function bones_custom_admin_footer() {
	_e( '<span id="footer-thankyou">Developed by <a href="http://wearebio.com" target="_blank">BioDesign</a></span>. Built using <a href="http://wearebio.com/osseous" target="_blank">Osseous</a>.', 'bonestheme' );
}
